...
public class PlanRestController {
	...
	public ResponseEntity<String> update(@PathVariable int planId, @RequestBody PlanParam planParam) {
		log.debug("plan.update..............planId : {}", planId);
		log.debug("plan.update..............planParam : {}", planParam);
		planService.updatePlan(planId, planParam);
	...
	public ResponseEntity<String> update(@PathVariable int planDetailId, @RequestBody PlanDetailParam planDetailParam) {
		log.debug("plan.update..............planDetailId : {}", planDetailId);
		log.debug("plan.update..............planDetailParam : {}", planDetailParam);
		planService.updatePlanDetail(planDetailId, planDetailParam);
		return new ResponseEntity<String>(SUCCESS, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> removePlanDetailById(@PathVariable int planDetailId) {
		...
		planService.deletePlan(planDetailId);
		return new ResponseEntity<String>(SUCCESS, HttpStatus.OK);
	}
